...
#ifndef BB_Adfrt_BMP085_H
#define BB_Adfrt_BMP085_H
...
public:
   ...
   */
  bool begin(uint8_t mode = BMP085_ULTRAHIGHRES, uint32_t fClock=100000L, uint8_t nSDA=0xff, uint8_t nSCL=0xff);
  /*!
